...
namespace SquareMatrix
{
    class Program
    {
        ...
        public static void SquareMatrix(int[][,] matrixTable)
        {
            ...
            switch (key)
            {
                case (char)Navigation.ViewMatrix:
                    // View matrix table

                    ViewMatrix(matrixTable);
                    break;

                case (char)Navigation.GenerateMatrix:
                    // Generate new matrix

                    AddNewMatrix(matrixTable);
                    break;

                case (char)Navigation.MatrixTranspose:
                    // Matrix Transpose

                    ShowTransposeMatrix(matrixTable);
                    break;

                case (char)Navigation.OutputTriangularMatrix:
